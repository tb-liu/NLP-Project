...
OPENAI_API_KEY = "sk-proj-RiY4pL6hkjktJVWezE1pT3BlbkFJuRVive76GWUqroadaT5G"
llm = OpenAI(openai_api_key=OPENAI_API_KEY)

# Example attributes for keyword generation
attributes = ["sucks","disgusting"] # works perfect
# attributes = ["wifi", "network"] # predict wifi
# attributes = ["kid", "child"] # predict kid-friendly

# Define the prompt for generating lowercase keywords
keywords_prompt = PromptTemplate.from_template(
    "Generate 20 lowercase keywords related to these reviews attributes: {attributes}. List them as comma-separated values."
)
...
print("the generated words",words)
print("the rating threshold",rating_threshold)
